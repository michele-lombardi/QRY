...
bundle_path="$app_root/target/$target_triple/release/bundle/macos/$product_name.app"
binary_path="$bundle_path/Contents/MacOS/typepulse-app"
info_plist="$bundle_path/Contents/Info.plist"
archive_path="$release_dir/$product_name-$release_version-$artifact_arch.app.zip"
